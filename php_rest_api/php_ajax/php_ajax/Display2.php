    ...
    function load_data(query)
    {
        ...
        success:function(data)
        {
            ...
            if(data.length > 0)
            {
                ...
                {
                    html += '<tr>';
                    html += `<td>${data[count].post_submit_id}</td>`;
                    html += '<td>'+data[count].post_title+'</td>';
                    html += '<td>'+data[count].post_description+'</td>';
                    html += '<td>'+data[count].post_category+'</td>';
                    html += '<td>'+data[count].post_sub_category+'</td>';
                    html += '<td>'+data[count].post_industry+'</td></tr>';
                }
            }else{
